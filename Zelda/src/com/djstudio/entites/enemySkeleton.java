...
public class enemySkeleton extends Enemy{
	...
	public int life = 4; // 4 life max
	public int dano = 1;
	
	public boolean isDamaged = false;
	
	public enemySkeleton(int x, int y, int width, int height, BufferedImage sprite) {
		...
		sprites[0] = Game.spritesheet.getSprite(160, 16, 16, 16);
		sprites[1] = Game.spritesheet.getSprite(176, 16, 16, 16);
		FEEDBACK_ENEMY[0] = Game.spritesheet.getSprite(160, 32, 16, 16);
		FEEDBACK_ENEMY[1] = Game.spritesheet.getSprite(176, 32, 16, 16);
